...
class weightViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBAction func btnClicked(_ sender: Any) {
        if ((valueTextField.text! as NSString).floatValue != 0 && timeIndenticator != nil) {
            ...
            case 0:
                ...
                break
            case 1:
                convertedValues[0] = (valueTextField.text! as NSString).floatValue * pow(10,3)
                ...
                convertedValues[4] = (valueTextField.text! as NSString).floatValue * pow(10,-6)
                convertedValues[5] = (valueTextField.text! as NSString).floatValue * pow(10,-9)
                break
            case 2:
                convertedValues[0] = (valueTextField.text! as NSString).floatValue * pow(10,4)
                ...
                convertedValues[4] = (valueTextField.text! as NSString).floatValue * pow(10,-5)
                convertedValues[5] = (valueTextField.text! as NSString).floatValue * pow(10,-8)
                break
            case 3:
                ...
                break
            case 4:
                convertedValues[0] = (valueTextField.text! as NSString).floatValue * pow(10,9)
                ...
                break
            case 5:
                convertedValues[0] = (valueTextField.text! as NSString).floatValue * pow(10,12)
                convertedValues[1] = (valueTextField.text! as NSString).floatValue * pow(10,9)
                convertedValues[2] = (valueTextField.text! as NSString).floatValue * pow(10,8)
                convertedValues[3] = (valueTextField.text! as NSString).floatValue * pow(10,6)
                convertedValues[4] = (valueTextField.text! as NSString).floatValue * pow(10,3)
    ...
    let time = ["Miligram","Gram", "Dekagram", "Kilgram", "Megagram", "Gigagram"]
